...
class PokemonDetailActivity : ComponentActivity() {
    ...
    private fun DetailActivity(
        ...
        val pokemon: PokemonData = getSerializable(this, "pokemonData", PokemonData::class.java)

        val gradientColors = listOf(Color(0xFF48B684), Color(0xFF216379))


        window.navigationBarColor = Color(0xFF216379).toArgb()
    ...
    fun <T : Serializable?> getSerializable(
        activity: Activity, name: String, clazz: Class<T>
    ): T {
